...
public class TodoData {
    ...
    public TodoData() {
        ...
        addItem(new TodoItem("fifth", "fifth detail", LocalDate.now()));
        addItem(new TodoItem("sixth", "sixth detail", LocalDate.now()));
        addItem(new TodoItem("seventh", "seventh detail", LocalDate.now()));
    }
